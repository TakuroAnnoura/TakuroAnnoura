...
職業訓練を通じてデータ分析・AIエンジニアリングを学び、Python / Django を中心にWebアプリ開発・業務改善ツールの制作に取り組んできました。
...
卒業制作では、前職で経験した支払通知書作成業務を題材に、CSV取込、入力チェック、重複検知、Excel帳票作成、確認・差戻し、再作成、進捗管理までを実装したDjango製の業務支援Webアプリを開発しました。
